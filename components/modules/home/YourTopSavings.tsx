...
export function YourTopSavings() {
    return (
        ...
        <Card className='mt-4'>
            ...
            <Text className='text-3xl mt-5' weight='bold'>
                {formatPrice(121765)}
            </Text>
            <Text className='mt-4'>
                <Text className='text-gray-500'>out of</Text> <Text weight='semi_bold'>{formatPrice(300000)} ({Math.round((121765 / 300000) * 100)}%) </Text>
            </Text>
            ...
            <View className='flex-row justify-between pt-3 items-center'>
                ...
                <Text>
                    {formatPrice(20000)} remaining
                </Text>
            </View>
            <ProgressBar progress={.9} className='mt-5' />
            <View className='bg-primary-100 mt-5 rounded-lg p-4 flex-row items-center'>
                <View
                ...
                <View className='px-5'>
                    <Text className='text-xl px-5'>
                        Almost there! you will reach your goal in 2 weeks.
                    </Text>
                </View>
            </View>
        </Card>
